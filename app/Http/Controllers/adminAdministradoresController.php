...
class adminAdministradoresController extends Controller
{
    ...
    public function redirecToSection($section){
        return view('adminAdministrators', ['section' => $section]);
    }

    public function nullSection(){
        return view('adminAdministrators', ['section' => 'agregar']);
    }
    ...
    public function store(CreateAdministradorRequest $request)
    {
        ...
        if($errorName || $errorIdRol || $errorxEmail){
            ...
            return view('adminAdministrators', ['section' => 'agregar', 'errores' => $errores]);
        }else{ 
            ...
            return redirect()->route('adminAdministradores.redirecToSection', ['section' => 'agregar']);
        }
    }
    ...
    public function update(ModifyAdministradorRequest $request)
    {
        ...
        if($errorvId || $errorAlias || $errorvSis){
            ...
            return view('adminAdministrators', ['section' => 'modificar', 'errores' => $errores]);
        }else{
            ...
            return redirect()->route('adminAdministradores.redirecToSection', ['section' => 'modificar']);
        }
    }
