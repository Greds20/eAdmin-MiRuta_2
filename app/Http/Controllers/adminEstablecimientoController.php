...
class adminEstablecimientoController extends Controller
{
    public function redirecToSection($section){
        return view('adminEstab', ['section' => $section]);
    }

    public function nullSection(){
        return view('adminEstab', ['section' => 'agregar']);
    }
    ...
    public function store(CreateEstablecimientoRequest $request)
    {
        ...
        if($errorName){
            ...
            return view('adminEstab', ['section' => 'agregar', 'errores' => $errores]);
        }else{
            ...
            return redirect()->route('adminEstablecimiento.redirecToSection', ['section' => 'agregar']);
        }
    }
    ...
    public function update(ModifyEstablecimientoRequest $request)
    {
        ...
        if($errorvEstab || $errorName){
            ...
            if($errorName)
                array_push($errores, "Nombre de establecimiento duplicado.");
            return view('adminEstab', ['section' => 'modificar', 'errores' => $errores]);
        }else{
            ...
            return redirect()->route('adminEstablecimiento.redirecToSection', ['section' => 'modificar']);
        }
    }
}
