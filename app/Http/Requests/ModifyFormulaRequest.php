...
class ModifyFormulaRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'vminF.*' => 'required|integer|max:99',
            'vmaxF.*' => 'required|integer|max:99',
            ...
            'vminSF.*' => 'required|integer|max:99',
            'vmaxSF.*' => 'required|integer|max:99',
    ...
    public function messages()
    {
        return [
            ...
            'vminF.*.max' => 'El valor minimo de los factores deben ser menor a 100.',
            'vmaxF.*.max' => 'El el valor máximo de los factores deben ser menor a 100.',
            ...
            'vminSF.*.max' => 'El valor minimo de los subfactores deben ser menor a 100.',
            'vmaxSF.*.max' => 'El el valor máximo de los subfactores deben ser menor a 100.',
